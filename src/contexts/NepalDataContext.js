...
const NepalDataProvider = props => {
	...
	return <NepalData.Provider value={{ provinceList, districtList, municipalityList, regionData, setSelectedProvince, setSelectedDistrict, setSelectedMunicipality }}>{props.children}</NepalData.Provider>;
};
